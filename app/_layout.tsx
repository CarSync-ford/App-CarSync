...
function RootLayoutNav() {
  ...
  useEffect(() => {
    ...
    const isAuthScreen = String(segments[0]) === 'login' || String(segments[0]) === 'mfa' || String(segments[0]) === 'register' || String(segments[0]) === 'two-factor-setup' || String(segments[0]) === 'two-factor-qrcode';
